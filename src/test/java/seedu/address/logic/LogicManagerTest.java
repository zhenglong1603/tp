...
import seedu.address.storage.JsonKlinixStorage;
...
public class LogicManagerTest {
    ...
    private void assertCommandSuccess(String inputCommand, String expectedMessage,
        ...
        CommandResult result = logic.executeWithoutConfirmation(inputCommand);
    ...
    private void assertCommandFailure(String inputCommand, Class<? extends Throwable> expectedException,
        ...
        assertThrows(expectedException, expectedMessage, () -> logic.executeWithoutConfirmation(inputCommand));
        assertEquals(expectedModel, model);
    }
    ...
    private void assertCommandFailureForExceptionFromStorage(IOException e, String expectedMessage) {
        ...
        JsonKlinixStorage addressBookStorage = new JsonKlinixStorage(prefPath) {
            @Override
            public void saveKlinix(ReadOnlyKlinix addressBook, Path filePath)
                    throws IOException {
                throw e;
            }
        };
