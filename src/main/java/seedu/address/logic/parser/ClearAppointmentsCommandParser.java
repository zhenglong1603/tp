...
/**
 * Parses input arguments and creates a new ClearAppointmentsCommand object
 */
public class ClearAppointmentsCommandParser implements Parser<ClearAppointmentsCommand> {

    /**
     * Parses the given {@code String} of arguments in the context of the ClearAppointmentsCommand
     * and returns an ClearAppointments object for execution.
    ...
    public ClearAppointmentsCommand parse(String args) throws ParseException {
        ...
        if (!arePrefixesPresent(argMultimap, PREFIX_NRIC)
            ...
            throw new ParseException(String.format(MESSAGE_INVALID_COMMAND_FORMAT,
                    ClearAppointmentsCommand.MESSAGE_USAGE));
        }
