...
/**
 * Edits the details of an existing patient in the klinix.
 */
public class EditCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD
            ...
            + PREFIX_PHONE + "PHONE] " + "[" + PREFIX_EMAIL + "EMAIL] " + "[" + PREFIX_NRIC
            + "NRIC] " + "[" + PREFIX_BIRTHDATE + "BIRTHDATE] " + "[" + PREFIX_ADDRESS + "ADDRESS] "
    ...
    public static final String MESSAGE_DUPLICATE_PERSON =
            "A patient with this NRIC already exists in the system. Please use a unique NRIC.";
    ...
    public CommandResult execute(Model model) throws CommandException {
        ...
        model.updateAppointments(personToEdit, editedPerson);
    ...
    private static Person createEditedPerson(Person personToEdit,
        ...
        BirthDate updatedBirthDate =
                editPersonDescriptor.getBirthDate().orElse(personToEdit.getBirthDate());
        ...
        AppointmentList appointmentList = personToEdit.getAppointmentList();

        AppointmentList temp = new AppointmentList();

        for (Appointment appointment : appointmentList) {
            temp.add(new Appointment(appointment.getDescription(),
                    appointment.getStartDateTime(),
                    appointment.getEndDateTime(),
                    updatedNric.toString(),
                    appointment.getVisited()));
        }
        appointmentList = temp;
        return new Person(updatedName, updatedPhone, updatedEmail, updatedNric, updatedBirthDate,
                updatedAddress, updatedTags, medicalReport, appointmentList);
    }
    ...
    public static class EditPersonDescriptor {
        ...
        public boolean isAnyFieldEdited() {
            return CollectionUtil.isAnyNonNull(name, phone, email, nric, birthDate, address, tags);
        }
        ...
        public String toString() {
            return new ToStringBuilder(this).add("name", name).add("phone", phone)
                    .add("email", email).add("nric", nric).add("birthDate", birthDate)
