...
| **`p`** | `PHONE_NUMBER`  | - Must be a valid phone number (at least 3 digits, e.g., 999).<br> - Multiple patients can share the same phone number, as it is used only for contact purposes (e.g., children sharing their parent's number).                                                                                                                                                                                                                                                                                            |
